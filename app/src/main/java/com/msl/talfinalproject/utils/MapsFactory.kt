...
object MapsFactory {
    ...
    fun drawRoute(context: Context): PolylineOptions {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            polylineOptions.color(context.resources.getColor(R.color.theme_blue_text_inverse, context.theme))
        } else {
            polylineOptions.color(context.resources.getColor(R.color.theme_blue_text_inverse))
        }
